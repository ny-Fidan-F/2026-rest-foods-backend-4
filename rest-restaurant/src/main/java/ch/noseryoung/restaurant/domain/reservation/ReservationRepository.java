...
public interface ReservationRepository extends JpaRepository<Reservation, UUID> {
    ...
    @Query("SELECT r FROM Reservation r WHERE r.table.id = :tableId AND r.start < :end AND r.end > :start")
    ...
    @Query("SELECT r FROM Reservation r WHERE r.table.id = :tableId AND r.id != :reservationId AND r.start < :end AND r.end > :start")
